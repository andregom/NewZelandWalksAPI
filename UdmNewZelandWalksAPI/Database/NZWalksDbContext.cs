        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Difficulty>().HasData(
                    new Difficulty
                    {
                        ...
                        Name = "Easy",
                        //Description = "Easy walk, mostly flat ground."
                    },
                    new Difficulty
                    {
                        Id = Guid.Parse("ea294873-7a8c-4c0f-bfa7-a2eb492cbf8c"),
                        Name = "Moderate",
                        //Description = "Moderate walk, some incline."
                    },
                    new Difficulty
                    {
                        Id = Guid.Parse("f808ddcd-b5e5-4d80-b732-1ca523e48434"),
                        Name = "Hard",
                        //Description = "Hard walk, steep incline."
                    }
            );
            ...
            //        {
            //            Id = Guid.NewGuid(),
            //            Name = "Auckland Bridge Walk",
            //            Description = "Walk over the Auckland Harbour Bridge.",
            ...
            //        {
            //            Id = Guid.NewGuid(),
            //            Name = "Wellington Waterfront Walk",
            //            Description = "Walk along the Wellington waterfront.",
            //            RegionId = Guid.Parse("cfa06ed2-bf65-4b65-93ed-c9d286ddb0de"),
            //            DifficultyId = Guid.Parse("f7248fc3-2585-4efb-8d1d-1c555f4087f6"),
            //            WalkImaUrl = "Some URL"
            //        },
            //        new Walk
            //        {
            //            Id = Guid.NewGuid(),
            //            Name = "Christchurch Park Walk",
            //            Description = "Walk through the Christchurch Botanic Gardens.",
            //            RegionId = Guid.Parse("f7248fc3-2585-4efb-8d1d-1c555f4087f6"),
            //            DifficultyId = Guid.Parse("f7248fc3-2585-4efb-8d1d-1c555f4087f6"),
            //            WalkImaUrl = "Some URL"
            //        }
